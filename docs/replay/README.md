...
Status: RPL-001 through RPL-016 implemented in repository scope; RPL-017 host baseline verified; final retro comparison follows the fixed-buffer proof
