...
Status: RPL-001 through RPL-017 implemented in repository scope; host, fixed-buffer, and cc65/FCEUX retro comparisons verified; the latter remains available through the documented external-toolchain command
